...
class HandGestures:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'HandGestures_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Hand Gestures')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'HandGestures')
        self.toolbar.setObjectName(u'HandGestures')

        #print "** INITIALIZING HandGestures"
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('HandGestures', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/HandGestures/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'webcam hand gestures'),
            callback=self.run,
    ...
    def unload(self):
        ...
        #print "** UNLOAD HandGestures"

        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&Hand Gestures'),
                action)
